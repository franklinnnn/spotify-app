  ...
  return (
    <div className="relative w-full my-6">
      <motion.div
        ...
        exit="hidden"
      >
        <h1 className="text-2xl max-sm:text-xl">About Cardify</h1>
        <div className="text-sm ">
          <p className="mb-6">
            Cardify is an app to keep track of your top listened tracks and
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
              ...
              <p>
                Top tracks and artists can be filtered from the last month, last
                6 months, or all time. Inspired by card collecting and deck
                building games, the hand of tracks and artists are generated 9
                at a time. Details are are displayed in a card design with
                colors denoting the level of popularity.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-4">
                <p className="w-2/3">
                  ...
                  values, and link to their Spotify pages. Artist's latest album
                  can be accessed similarly to the tracks. The bottom menu
                  'Recommend' button will generate the artist's related artists.
                  Option to follow the artist is here, instead of the 'Add to
                  Deck' button.
                </p>
                <img
                  src={artistCardImg}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <p>
                ...
                Spotify. Unfortunately, Spotify does not provide the actual
                count of how many times a track or an artist was listened to, so
            ...
            <div>
              ...
              <p>
                ...
                that use Spotify's API, like Receiptify. Decided to see what
                else I can access with the Spotify API. I'm not too fond of the
                way the actual Spotify app handles new recommendations, so I'm
                trying to make something that I at least like. Also I wanted
                access to certain song features like tempo, which I use on
                running playlists.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>
                I used React with Vite. Repository can be found{" "}
                <a
